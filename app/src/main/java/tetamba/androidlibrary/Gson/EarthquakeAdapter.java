    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.gson_list_item, parent, false);
        }
        ...
        TextView magnitudeTextView = (TextView) listItemView.findViewById(R.id.gson_magnitude);
        ...
        TextView locationTextView = (TextView) listItemView.findViewById(R.id.gson_location);
        ...
        TextView dateView = (TextView) listItemView.findViewById(R.id.gson_date);
